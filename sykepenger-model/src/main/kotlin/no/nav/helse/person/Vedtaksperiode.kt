...
internal class Vedtaksperiode private constructor(
    ...
    internal fun håndter(hendelse: OverstyrTidslinje, aktivitetslogg: IAktivitetslogg) {
        håndterSykdomstidslinjeHendelse(hendelse, aktivitetslogg) {
            ...
            if (arbeidsgiverperiodeFørOverstyring == arbeidsgiverperiodeEtterOverstyring) return@håndterSykdomstidslinjeHendelse
    ...
    private fun håndterOppgittRefusjon(arbeidsgiveropplysninger: Arbeidsgiveropplysninger, vedtaksperioder: List<Vedtaksperiode>, aktivitetslogg: IAktivitetslogg, ubrukteRefusjonsopplysninger: Refusjonsservitør): List<Revurderingseventyr> {
        ...
        val eventyr = vedtaksperioder.mapNotNull { vedtaksperiode ->
            if (vedtaksperiode.håndter(arbeidsgiveropplysninger, aktivitetslogg, servitør)) Revurderingseventyr.refusjonsopplysninger(arbeidsgiveropplysninger, vedtaksperiode.skjæringstidspunkt, vedtaksperiode.periode)
            else null
        }
    ...
    private fun håndterDagerUtenEndring(dager: DagerFraInntektsmelding, aktivitetslogg: IAktivitetslogg) {
        val bit = dager.tomBitAvInntektsmelding(aktivitetslogg, periode)
        håndterDager(dager.hendelse, bit, aktivitetslogg) {
    ...
    internal fun igangsettOverstyring(revurdering: Revurderingseventyr, aktivitetslogg: IAktivitetslogg) {
        ...
        videreførEksisterendeOpplysninger(aktivitetslogg)
    }
    ...
    private fun videreførEksisterendeOpplysninger(aktivitetslogg: IAktivitetslogg) {
        lagreGjenbrukbarInntekt(aktivitetslogg)
        videreførEksisterendeRefusjonsopplysninger(aktivitetslogg = aktivitetslogg)
    }
    ...
    internal sealed interface Vedtaksperiodetilstand : Aktivitetskontekst {
        ...
        fun håndter(vedtaksperiode: Vedtaksperiode, hendelse: OverstyrTidslinje, aktivitetslogg: IAktivitetslogg) = when (this) {
            Avsluttet,
            AvsluttetUtenUtbetaling,
            AvventerBlokkerendePeriode,
            AvventerGodkjenning,
            ...
            RevurderingFeilet,
            Start,
            TilInfotrygd -> error("Kan ikke overstyre tidslinje i $this")
        }
    ...
    internal data object AvventerRevurdering : Vedtaksperiodetilstand {
        ...
        override fun håndter(vedtaksperiode: Vedtaksperiode, påminnelse: Påminnelse, aktivitetslogg: IAktivitetslogg) {
            if (vedtaksperiode.måInnhenteInntektEllerRefusjon()) {
                vedtaksperiode.videreførEksisterendeOpplysninger(aktivitetslogg)
